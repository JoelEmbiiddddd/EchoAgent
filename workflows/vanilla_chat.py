...
class VanillaChatWorkflow(BaseWorkflow):
    """Minimal chat workflow using a single vanilla_chat agent profile."""
    ...
    def __init__(self, config):
        ...
        self.chat_agent = EchoAgent(context=self.context, profile="vanilla_chat", llm=llm)
