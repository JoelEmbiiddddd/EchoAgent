...
class BrowserMCPWorkflow(BaseWorkflow):
    """Simple workflow that exercises the Browser MCP server via the browser profile."""
    ...
    def __init__(self, config):
        ...
        self.browser_agent = EchoAgent(context=self.context, profile="browser", llm=llm, name="browser_agent")
    ...
    async def run(self, query: Any = None) -> Any:
        ...
        self.update_printer("initialization", "Browser MCP workflow initialized", is_done=True)
