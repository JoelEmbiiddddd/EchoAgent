...
from echoagent.context.conversation import identity_wrapper
from echoagent.utils.helpers import extract_final_output, parse_to_model
...
class EchoAgent(Agent[TContext]):
    ...
    def __init__(
        ...
        **agent_kwargs: Any,
        ...
        if output_schema:
            if not model_supports_json_and_tool_calls(llm):
